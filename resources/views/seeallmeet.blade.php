				...
				<ul class="clearfix">
					<li>
						<div class="switch-field">
							...
							<label for="latest">Terakhir</label>
						</div>
					</li>
					<li>
					</li>
				...
				<div class="col-lg-9">
					<div class="strip list_view">
						<div class="row no-gutters">
							<div class="col-lg-5">
								<figure>
									<a href="{{'detailmeet'}}"><img src="img/jm.jpg" class="img-fluid" alt=""><div class="read_more"><span>Baca Selengkapnya</span></div></a>
							...
							<div class="col-lg-7">
								<div class="wrapper">
									...
									<h3><a href="{{'detailmeet'}}">Hotel Grand Aston</a></h3>
									<a class="address" href="https://www.google.co.id/maps/place/Grand+Aston+Yogyakarta/@-7.7828974,110.3796857,17z/data=!3m1!4b1!4m8!3m7!1s0x2e7a59cdc51c9a37:0x9e47fb45ae5bd6b8!5m2!4m1!1i2!8m2!3d-7.7828974!4d110.3818744">Lihat pada Peta</a>
									<br>
									<p>
									Grand Aston Yogyakarta telah meningkatkan fasilitas untuk Meeting memiliki 5 ruang pertemuan yang mampu menampung hingga 70 orang di setiap ruangannya...
									</p>
								</div>
								<ul>
					...
					<div class="strip list_view">
						<div class="row no-gutters">
							<div class="col-lg-5">
								<figure>
									<a href="{{'detailmeet'}}"><img src="img/jktm.jpg" class="img-fluid" alt=""><div class="read_more"><span>Baca Selengkapnya</span></div></a>
								</figure>
							</div>
							<div class="col-lg-7">
								<div class="wrapper">
									<a href="#0" class="wish_bt"></a>
									<h3><a href="{{'detailmeet'}}">Wisma Iskandarsyah</a></h3>
									<a class="address" href="https://www.google.co.id/maps/place/Wisma+Iskandarsyah,+Jl.+Iskandarsyah+Raya+Blok+C+9,+RT.5%2FRW.4,+Melawai,+Kec.+Kby.+Baru,+Kota+Jakarta+Selatan,+Daerah+Khusus+Ibukota+Jakarta+12160/@-6.245638,106.8028592,17z/data=!3m1!4b1!4m5!3m4!1s0x2e69f16f778a4c49:0xd2bb02f8f342af4a!8m2!3d-6.245638!4d106.8050479">Lihat pada Peta</a>
									<br>
									<p>
									Sewa office space / ruang kantor Graha Iskandarsyah murah, lokasi strategis, siap pakai. Bayar bulanan atau tahunan...
									</p>
					...
					<div class="strip list_view">
						<div class="row no-gutters">
							<div class="col-lg-5">
								<figure>
									<a href="{{'detailmeet'}}"><img src="img/sbym.jpg" class="img-fluid" alt=""><div class="read_more"><span>Baca Selengkapnya</span></div></a>
								</figure>
							</div>
							<div class="col-lg-7">
								<div class="wrapper">
									<a href="#0" class="wish_bt"></a>
									<h3><a href="{{'detailmeet'}}">Hotel Luminor</a></h3>
									<a class="address" href="https://www.google.co.id/maps/place/Hotel+Luminor+Pecenongan/@-6.1645715,106.8238979,17z/data=!3m1!4b1!4m8!3m7!1s0x2e69f5da5ecda557:0x231ad86e140e0b89!5m2!4m1!1i2!8m2!3d-6.1645715!4d106.8260866">Lihat pada Peta</a>
									<br>
									<p>
									Luminor Hotel Pecenongan menyediakan 5 Ruang Rapat yang tersedia untuk fungsi multi-tujuan dan dapat menampung 10 hingga 300 orang
                                    Bandingkan harga dan temukan promo terbaik untuk Luminor Hotel...
					...
					<div class="strip list_view">
						<div class="row no-gutters">
							<div class="col-lg-5">
								<figure>
									<a href="{{'detailmeet'}}"><img src="img/mlgm.jpeg" class="img-fluid" alt=""><div class="read_more"><span>Baca Selengkapnya</span></div></a>
							...
							<div class="col-lg-7">
								<div class="wrapper">
									<a href="#0" class="wish_bt"></a>
									<h3><a href="{{'detailmeet'}}">Hotel Swiss Bellin</a></h3>
									<a class="address" href="https://www.google.co.id/maps/place/Hotel+Swiss-Belinn+Kemayoran,+Jakarta/@-6.1494685,106.8483776,17z/data=!3m1!4b1!4m8!3m7!1s0x2e69f590da43a0c9:0x64f73e0f9910836d!5m2!4m1!1i2!8m2!3d-6.1494685!4d106.8505663">Lihat pada Peta</a>
									<p>
									Swiss-Belinn Airport Surabaya menawarkan tujuh ruang pertemuan yang dirancang untuk mengakomodasi berabagai acara bisnis dan acara sosial
                                    Ruang training Makmur 1 ini menyediakan ruangan training dengan kapasitas untuk 18 orang. Ruang training ini berada didalam hotel berbintang yang ...
									</p>
